...
/* build-hook-start *//*00001*/try { require('c:\\users\\nazim\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.243\\out\\buildhook\\index.js').default({tool: 'webpack'}); } catch(cjsError) { try { import('file:///c:/users/nazim/.vscode/extensions/wallabyjs.console-ninja-1.0.243/out/buildhook/index.js').then(m => m.default.default({tool: 'webpack'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
