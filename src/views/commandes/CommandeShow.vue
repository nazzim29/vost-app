    ...
    <div class="card glass">
      <div class="card-body">
        ...
        <div class="flex flex-row h-full gap-3">
          <div
            class="bg-yellow-300 rounded-md w-16 h-16 flex flex-row py-2 px-1 hover:scale-110 hover:shadow-2xl hover:mx-3 transition-all duration-300 items-center"
          >
          ...
          <div
            class="bg-yellow-300 rounded-md w-1/4 h-16 flex flex-row py-2 px-1 hover:scale-110 hover:shadow-2xl hover:mx-3 transition-all duration-300 items-center"
          >
